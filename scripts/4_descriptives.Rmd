...
summary_table_whole_sample <-
  ...
  gtsummary::tbl_summary(
    ...
    type = list(
      ...
      mhd.personality_disorder = "dichotomous",
      mhd.mdd = "dichotomous",
      mhd.gad = "dichotomous",
      mhd.social_anxiety = "dichotomous",
      mhd.specific_phobia_ = "dichotomous",
...
summary_table_whole_sample %>%
  ...
  flextable::save_as_docx(
    path = paste0(bddtrauma_folder, "tables/", date, "/BDDTRAUMA_descriptives", date, ".docx"),
...
summary_table_clinical %>%
  as_flex_table() %>%
  flextable::save_as_docx(
    path = paste0(LBGTQ_folder, "tables/", date, "/LGBTQ_descriptives_clin", date, ".docx"),
