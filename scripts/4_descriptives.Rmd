...
```{r dat_gender dat mdd}
#Zusammenfügen zu einer mdd Variable
dat_gender <- dat_gender %>%
  mutate(
    any_mdd_diagnosis = ifelse(
      mhd.mdd == "MDD" | 
...
```{r dat_gender dat gad}
#Zusammenfügen zu einer gad Variable
dat_gender <- dat_gender %>%
  mutate(
    any_gad_diagnosis = ifelse(
      mhd.gad == "GAD" | 
      cidia.diagnosis == "No GAD diagnosis" | 
      gad7.sum_score < 10,
      "GAD",
      "No GAD"
    )
...
summary_table_clinical_gender <-
  ...
  gtsummary::tbl_summary(
    ...
    label = list(
      ...
      sexual_orientation = "Sexual orientation",
      dem.highest_education_collapsed = "Highest education",
      #cidid.mdd_diagnosis = "Major depressive disorder diagnosis",
      #cidia.diagnosis = "Generalised anxiety disorder diagnosis",
      #mhd.mdd = "Major depressive disorder",
      #mhd.gad = "Generalised anxiety disorder",
...
summary_table_clinical_sexual_orientation <-
  ...
  gtsummary::tbl_summary(
    ...
    label = list(
      ...
      dem.highest_education_collapsed = "Highest education",
      #cidid.mdd_diagnosis = "Major depressive disorder diagnosis",
      #cidia.diagnosis = "Feneralised anxiety diagnosis",
      #mhd.mdd = "Major depressive disorder",
      #mhd.gad = "Generalised anxiety disorder",
      any_mdd_diagnosis = "Major depressive disorder",
      any_gad_diagnosis = "Generalised anxiety disorder",
