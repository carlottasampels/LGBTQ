...
```{r dat_demographics_clinical_sexual_orientation}
...
```{r create category trans persons}
dat_prepared <- dat_demographics_clinical_gender %>%
  mutate(gender = fct_collapse(gender,
    "Trans persons" = c("Trans woman", "Trans man")
  ))
```
...
```{r summary_table_clinical_sexual_orientation}
