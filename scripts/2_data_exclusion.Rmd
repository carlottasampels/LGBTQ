...
study_cohorts <- 
  ...
  cohort_define(
    ...
    nogender.noage.noethnicity =
      nogender.noage %>%
      drop_na(ethnicity),
    
    missing_ethnicity = anti_join(
      x = nogender.noage,
      y =  nogender.noage.noethnicity,
      by = "ID"),
    
    nogender.noage.noethnicity.nosexuality =
      nogender.noage.noethnicity %>%
      drop_na(sexual_orientation),
    
    missing_sexuality = anti_join(
      x = nogender.noage.noethnicity,
      y =  nogender.noage.noethnicity.nosexuality,
      by = "ID"),

    
    nogender.noage.noethnicity.nosexuality.nobmiheight =
      nogender.noage.noethnicity.nosexuality %>%
      drop_na(
        bmi,
        height_m
    ...
    missing_bmiheight = anti_join(
      x = nogender.noage.noethnicity.nosexuality,
      y =  nogender.noage.noethnicity.nosexuality.nobmiheight,
      by = "ID"),
    
    nogender.noage.noethnicity.nosexuality.nobmiheight.noedu =
      nogender.noage.noethnicity.nosexuality.nobmiheight %>%
    ...
    nogender.noage.noethnicity.nosexuality.nobmiheight.noedu.nomhd = 
      nogender.noage.noethnicity.nosexuality.nobmiheight.noedu %>%
      drop_na(
        psy_dx_factors
        ),
  ...
  cohort_label(
    ...
    nogender.noage.noethnicity.nosexuality =
      "With gender, age, ethnicity, sexuality",
    nogender.noage.noethnicity.nosexuality.nobmiheight =
      "With gender, age, ethnicity, sexuality, BMI, height",
    nogender.noage.noethnicity.nosexuality.nobmiheight.noedu =
      "With gender, age, ethnicity, sexuality, BMI, height, education",
    nogender.noage.noethnicity.nosexuality.nobmiheight.noedu.nomhd =
      "With gender, age, ethnicity, sexuality, BMI, height, education, MHD",
...
study_consort <- study_cohorts %>%
  ...
  consort_box_add(
    name = "nogender.noage.noethnicity",
    x = 0,
    y = -40,
    label =  cohort_count_adorn(
      study_cohorts,
  ...
  consort_box_add(
    name = "nogender.noage.noethnicity.nosexuality",
    x = 0,
    y = -50,
    label =  cohort_count_adorn(
      study_cohorts,
  ...
  consort_box_add(
    name = "nogender.noage.noethnicity.nosexuality.nobmiheight",
    x = 0,
    y = -80,
    label =  cohort_count_adorn(
      study_cohorts,
  ...
  consort_box_add(
    name = "nogender.noage.noethnicity.nosexuality.nobmiheight.noedu",
    x = 0,
    y = -90,
    label =  cohort_count_adorn(
      study_cohorts,
  ...
  consort_box_add(
    name = "nogender.noage.noethnicity.nosexuality.nobmiheight.noedu.nomhd",
    x = 0,
    y = -100,
    label =  cohort_count_adorn(
      study_cohorts,
  ...
  consort_arrow_add(
    end = "nogender.noage", end_side = "top", start_x = 0, start_y = -20
  ) %>%
  consort_arrow_add(
    end = "missing_age", end_side = "left", start_x = 0, start_y = -25
  ) %>%
  consort_arrow_add(
    end = "nogender.noage.noethnicity", end_side = "top", start_x = 0, start_y = -30
  ) %>%
  consort_arrow_add(
    end = "missing_ethnicity", end_side = "left", start_x = 0, start_y = -35
  ) %>%
  consort_arrow_add(
    end = "nogender.noage.noethnicity.nosexuality", end_side = "top", start_x = 0, start_y = -40
  ) %>%
  consort_arrow_add(
    end = "missing_sexuality", end_side = "left", start_x = 0, start_y = -45
  ) %>%
  consort_arrow_add(
    end = "nogender.noage.noethnicity.nosexuality.nobmiheight", end_side = "top", start_x = 0, start_y = -70
  ) %>%
  consort_arrow_add(
    end = "missing_bmiheight", end_side = "left", start_x = 0, start_y = -75
  ) %>%
  consort_arrow_add(
    end = "nogender.noage.noethnicity.nosexuality.nobmiheight.noedu", end_side = "top", start_x = 0, start_y = -80
  ) %>%
  consort_arrow_add(
    end = "missing_edu", end_side = "left", start_x = 0, start_y = -85
  ) %>%
  consort_arrow_add(
    end = "nogender.noage.noethnicity.nosexuality.nobmiheight.noedu.nomhd", end_side = "top", start_x = 0, start_y = -90
  ) %>%
  consort_arrow_add(
    end = "missing_mhd", end_side = "left", start_x = 0, start_y = -95
  )
...
missing_age <- nrow(nogender.noage)-nrow(nogender)
missing_age
```
...
missing_ethnicity <-
  nrow(nogender.noage.noethnicity) -
  nrow(nogender.noage)
...
dim(nogender.noage.noethnicity)
...
missing_sexuality <-
  nrow(nogender.noage.noethnicity.nosexuality) -
  nrow(nogender.noage.noethnicity)
...
dim(nogender.noage.noethnicity.nosexuality)
...
missing_bmi <-
  nrow(nogender.noage.noethnicity.nosexuality.nobmiheight) - 
  nrow(nogender.noage.noethnicity.nosexuality)
...
dim(nogender.noage.noethnicity.nosexuality.nobmiheight)
...
missing_edu <-
  nrow(nogender.noage.noethnicity.nosexuality.nobmiheight.noedu) - 
  nrow(nogender.noage.noethnicity.nosexuality.nobmiheight)
...
```{r Exclusion mhd}
dim(nogender.noage.noethnicity.nosexuality.nobmiheight.noedu)

nogender.noage.noethnicity.nosexuality.nobmiheight.noedu.nomhd<- nogender.noage.noethnicity.nosexuality.nobmiheight.noedu %>%
  drop_na(
    all_of(psy_dx_factors)
  )

missing_mhd <-
  nrow(nogender.noage.noethnicity.nosexuality.nobmiheight.noedu.nomhd) -
  nrow(nogender.noage.noethnicity.nosexuality.nobmiheight.noedu)
