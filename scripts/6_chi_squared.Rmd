...
```{r chi squared test anwenden sexual_orientation}
target_vars <- c("age", "sex", "gender", "ethnicity", "dem.highest_education_collapsed", "mhd.social_anxiety", "mhd.specific_phobia",  "mhd.agoraphobia", "mhd.panic_attacks", "mhd.ocd", "mhd.bdd", "mhd.an", "mhd.atypical_an", "mhd.bn", "mhd.bed", "mhd.schizophrenia", "mhd.ptsd", "mhd.addadhd", "phq.Q9_suicidality_binary")
...
target_vars <- c("age", "sex", "sexual_orientation", "ethnicity", "dem.highest_education_collapsed", "mhd.social_anxiety", "mhd.specific_phobia",  "mhd.agoraphobia", "mhd.panic_attacks", "mhd.ocd", "mhd.bdd", "mhd.an", "mhd.atypical_an", "mhd.bn", "mhd.bed", "mhd.schizophrenia", "mhd.ptsd", "mhd.addadhd", "phq.Q9_suicidality_binary")
