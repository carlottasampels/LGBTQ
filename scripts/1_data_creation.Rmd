...
-   cidia_glad_clean.rds

-   cidid_glad_clean.rds
...
cidia_items_numeric <-
  c(
#"cidia.antianxiety_medication_numeric",
#"cidia.cbt_numeric",
"cidia.control_difficult_find_worry_numeric",
"cidia.counselling_numeric",
"cidia.did_you_find_the_medication_helpful_numeric",
"cidia.did_you_take_your_medication_as_advised_numeric",
"cidia.drugs_or_alcohol_numeric",
"cidia.easily_tired_numeric",
"cidia.enrolled_psychotherapy_nhs_funded_numeric",
"cidia.family_therapy_numeric",
"cidia.felt_worried_tense_anxious_numeric",
"cidia.felt_worried_tense_problems_numeric",
"cidia.group_therapy_numeric",
"cidia.guided_selfhelp_numeric",
"cidia.having_tense_sore_or_aching_muscles_numeric",
"cidia.job_security_failing_health_numeric",
"cidia.keyed_up_or_on_edge_numeric",
"cidia.life_lasting_estimate_number_numeric",
"cidia.life_lasting_month_longer_numeric",
"cidia.life_lasting_month_longer.1_numeric",
"cidia.life_lasting_months_kind_numeric",
"cidia.longest_period_continued_kind.2_numeric",
"cidia.longest_period_continued_kind.3_numeric",
"cidia.longest_period_continued_kind.4_numeric",
"cidia.longest_period_worry_categorical_combined_numeric",
"cidia.lot_people_things_situation_numeric",
"cidia.matter_hard_strong_mind_numeric",
"cidia.mind_difficulty_keeping_numeric",
"cidia.mind_worries_time_numeric",
"cidia.mindfulness_numeric",
"cidia.more_irritable_than_usual_numeric",
"cidia.number_of_episodes_numeric",
"cidia.often_having_trouble_falling_or_staying_asleep_numeric",
"cidia.people_period_worry_stronger_numeric",
"cidia.prescribed_medication_numeric",
"cidia.professional_problems_numeric",
"cidia.psychotherapy_numeric",
"cidia.regular_physical_exercise_numeric",
"cidia.relationship_therapy_numeric",
"cidia.restless_numeric",
"cidia.stop_worrying_difficult_find_numeric",
"cidia.structured_wellbeing_activity_numeric",
"cidia.talking_therapy_complete_psychotherapy_numeric",
"cidia.talking_therapy_helpful_find_numeric",
"cidia.therapy_dont_know_numeric",
"cidia.therapy_none_numeric",
"cidia.therapy_other_numeric",
"cidia.therapy_pnta_numeric",
"cidia.treatment_none_numeric",
"cidia.treatment_pnta_numeric",
"cidia.unprescribed_medication_numeric",
"cidia.workshops_numeric",
"cidia.did_you_worry_most_days_numeric"
  )

cidia_items <-
  c(
"cidia.felt_worried_tense_anxious",
"cidia.longest_period_continued_kind",
"cidia.longest_period_continued_kind",
"cidia.lot_people_things_situation",
"cidia.people_period_worry_stronger",
"cidia.did_you_worry_most_days",
"cidia.job_security_failing_health",
"cidia.stop_worrying_difficult_find",
"cidia.mind_worries_time",
"cidia.matter_hard_strong_mind",
"cidia.control_difficult_find_worry",
"cidia.restless",
"cidia.keyed_up_or_on_edge",
"cidia.easily_tired",
"cidia.mind_difficulty_keeping",
"cidia.more_irritable_than_usual",
"cidia.having_tense_sore_or_aching_muscles",
"cidia.often_having_trouble_falling_or_staying_asleep",
"cidia.felt_worried_tense_problems",
"cidia.longest_period_continued_kind",
"cidia.longest_period_continued_kind",
"cidia.life_lasting_month_longer",
"cidia.life_lasting_month_longer",
"cidia.age_fine_put_years.txt_unc",
"cidia.age_fine_put_years.txt_unc",
"cidia.age_fine_put_years.txt_unc",
"cidia.age_fine_put_years.txt_unc",
"cidia.longest_period_continued_kind",
"cidia.life_lasting_months_kind",
"cidia.life_lasting_estimate_number",
"cidia.did_you_take_your_medication_as_advised",
"cidia.did_you_find_the_medication_helpful",
"cidia.professional_problems",
"cidia.prescribed_medication",
"cidia.antianxiety_medication",
"cidia.unprescribed_medication",
"cidia.drugs_or_alcohol",
"cidia.psychotherapy",
"cidia.structured_wellbeing_activity",
"cidia.regular_physical_exercise",
"cidia.treatment_none",
"cidia.treatment_pnta",
"cidia.counselling",
"cidia.group_therapy",
"cidia.cbt",
"cidia.mindfulness",
"cidia.guided_selfhelp",
"cidia.workshops",
"cidia.online_therapy",
"cidia.family_therapy",
"cidia.relationship_therapy",
"cidia.therapy_other",
"cidia.therapy_none",
"cidia.therapy_dont_know",
"cidia.therapy_pnta",
"cidia.enrolled_psychotherapy_nhs_funded",
"cidia.talking_therapy_complete_psychotherapy",
"cidia.talking_therapy_helpful_find",
"cidia.age_fine_put_years.txt",
"cidia.age_fine_put_years.txt",
"cidia.age_fine_put_years.txt",
"cidia.age_fine_put_years.txt",
"cidia.number_of_episodes_numeric",
"cidia.longest_period_continued_kind.years",
"cidia.longest_period_continued_kind.years",
"cidia.longest_period_continued_kind.calc",
"cidia.longest_period_worry_cont_combined",
"cidia.longest_period_worry_categorical_clean",
...
dat <- dat %>%
  filter(
    is.na(gender) | is.na(dem.sex) |
      !(
        (gender == "Cis woman" & dem.sex == "Male") |
        (gender == "Cis man" & dem.sex == "Female") |
        (gender == "Trans woman" & dem.sex == "Female") |
        (gender == "Trans man" & dem.sex == "Male")
      )
  )
  ...
  mutate(
    ethnicity =
      case_when(
        ...
        dem.what_is_your_ethnic_origin %in% c("Asian or Asian British", "Arab", "Black or Black British", "Other", "Mixed") ~
          "Not white",
